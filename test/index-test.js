...
describe('President', function() {
  let lyndonJohnson
  before(() => {
    lyndonJohnson = new President("Lyndon B Johnson", "Democrat",
      "1963-1969", "Texas")
  })

  describe('Presidents Constructor Function', function() {
    it(
      'can create a president with a name, home state, political party, and years in office',
      function() {
  ...
  describe('doCharity()', function() {
    it('returns "I like to help people."', function() {
      expect(lyndonJohnson.doCharity()).toEqual(
  ...
  describe('conductPressInterview()', function() {
    it('returns "I am proud to be an American."', function() {
      expect(lyndonJohnson.conductPressInterview()).toEqual(
  ...
  describe('sayHi()', function() {
    it(
      ...
      function() {
        expect(lyndonJohnson.sayHi()).toEqual(
          "Hi, my name is Lyndon B Johnson. I am from Texas. I represent the Democrats, and was in office 1963-1969."
        )
      })
  })
})
